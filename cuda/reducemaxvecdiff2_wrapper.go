...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_33950_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd24, reducemaxvecdiff2$__cuda_local_var_33950_35_non_const_sdata;
...
BB0_8:
	...
	.loc 1 14 1
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_33950_35_non_const_sdata];
	.loc 2 2750 10
	abs.f32 	%f39, %f38;
	.loc 1 14 37
	mov.b32 	 %r13, %f39;
...
)
{
	...
	.reg .b64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_16949_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_16949_35_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_16949_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
